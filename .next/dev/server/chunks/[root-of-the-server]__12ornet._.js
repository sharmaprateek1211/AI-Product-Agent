...
function getOpenAIModel() {
    ...
    if (normalized === "gpt-3.5" || normalized === "gpt-3.5-turbo" || normalized.includes("gpt-3.5")) {
        return {
            model: "gpt-3.5-turbo",
...
async function POST(req) {
    try {
        ...
        const { mode, url, description, targetCustomer, current, instruction } = await req.json();
        if (!url || !description) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
Return keys: productName, description, targetUsers, problem, keyFeatures, businessModel, improvements, mvpFeatures, navigation, pages, uiDirection.`;
        ...
        const text = useResponsesApi ? data.output_text || "" : data.choices?.[0]?.message?.content || "";
        let result;
        try {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__12ornet._.js.map